                ...
                val jsonObjectRequest = JsonObjectRequest(Request.Method.GET, url, null,
                        { response ->
                            ...
                            try {
                                ...
                                Picasso.get().load(news_a.getString("image_url")).into(views, R.id.news_widget_image_a, intArrayOf(appWidgetId))
                                ...
                                Picasso.get().load(news_b.getString("image_url")).into(views, R.id.news_widget_image_b, intArrayOf(appWidgetId))
